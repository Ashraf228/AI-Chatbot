...
export async function GET() {
  ...
  console.log("BACKEND_BASE_URL loaded:", base);
  console.log("ADMIN_KEY exists:", !!adminKey);
  console.log("ADMIN_KEY length:", adminKey?.length ?? 0);
  console.log("ADMIN_KEY preview:", adminKey ? `${adminKey.slice(0, 6)}...${adminKey.slice(-4)}` : "missing");
