...
export const WIZARD_STEPS: WizardStep[] = [
  ...
  { key: "launch", label: "Review & Livegang", description: "Interner Test, Chatfenster-Code und Aktivierungsgrenzen" },
];
...
export const STEP_EXPLANATIONS: Record<WizardStepKey, string> = {
  ...
  launch: "Zum Schluss werden Einrichtungsstand, interner Test, Chatfenster-Code und Aktivierungsgrenzen geprueft.",
};
